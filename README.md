...
Exact stable route: `stable`; signing fingerprint:
...
echo "deb [signed-by=/usr/share/keyrings/ait-native-archive-keyring.gpg] https://raw.githubusercontent.com/weita2026/apt-ait-native/main stable main" \
